...
export const fetchAndUpdateProducts = async (): Promise<void> => {
  try {
    ...
    console.log(`📦 Fetched ${products.length} products from Amul API`);
